                    ...
                    <div class="col-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="blank.php">Blank Page</a></li>
                                <li class="breadcrumb-item active">Add Blank Page</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <h6 class="card-subtitle">List of blank page</h6>
