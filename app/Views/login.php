                        ...
                        <div class="col-md-6 login-block1 pt-3 pr-1 pr-md-5 mb-4 mb-md-0">
                            <div class="login-box card pt-4 mb-0 mx-auto">
                                <div class="card-body p-0 pr-1 pr-md-5">
                                    <form class="needs-validation form-control-line" novalidate id="loginform" action="/login" method="post">
                                        ...
                                        <div class="form-row m-t-40">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <a href="/register" class="btn btn-login btn-block text-uppercase font-weight-bold">REGISTER</a>
                                            </div>
                                        </div>
